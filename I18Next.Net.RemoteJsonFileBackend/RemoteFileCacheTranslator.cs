...
{
    public class RemoteFileCacheTranslator : ITranslator, IRemoteTranslationFileCache
    {
        ...
        public RemoteFileCacheTranslator(ITranslationBackend backend, ILogger logger, IPluralResolver pluralResolver, IInterpolator interpolator)
        {
            _backend = backend;
            _logger = logger;
        ...
        public RemoteFileCacheTranslator(ITranslationBackend backend)
        {
            _backend = backend;
        ...
        public RemoteFileCacheTranslator(ITranslationBackend backend, IInterpolator interpolator)
        {
            _backend = backend;
            _logger = new TraceLogger();
            _pluralResolver = new DefaultPluralResolver();
